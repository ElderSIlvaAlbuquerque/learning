...
async function fetchTopic(topic: string, attempt = 1): Promise<BookRecord[]> {
...
async function main(): Promise<void> {
  if (!API_KEY) {
    console.log(
      'No GOOGLE_BOOKS_API_KEY set — using the anonymous quota, which Google throttles aggressively. ' +
